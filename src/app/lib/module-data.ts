...
export const cadovaModules: CadovaModule[] = [
  ...
  slug: "skillia",
  name: "SkillIA",
  tagline: "Pour que ton profil LinkedIn renforce enfin ton dossier au lieu de le brouiller.",
  shortDescription: "Analyse ton profil, clarifie ton resume et mets en avant les bonnes competences pour les recruteurs.",
  fullDescription:
    "SkillIA t'aide a clarifier ce que tu montres aux recruteurs. Tu colles ton profil, tu identifies ce qui manque, puis tu ajustes ton resume et tes competences pour rendre ton parcours plus lisible et plus coherent.",
  targetAudience: [
  ...
  ctaHref: "/signup",
  previewTitle: "Profil LinkedIn",
  previewMetrics: [
    { label: "Resume", value: "plus clair" },
    { label: "Competences", value: "mieux choisies" },
    { label: "Profil", value: "plus lisible" },
  ],
  plans: [
    {
      name: "Solo",
