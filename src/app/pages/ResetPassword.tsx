...
export function ResetPassword() {
  ...
  // Supabase envoie l'utilisateur ici avec un access_token dans le hash (#)
  // ou bien onAuthStateChange déclenche un événement RECOVERY.
  ...
  useEffect(() => {
    ...
    // Timeout : si après 5s on n'a pas reçu PASSWORD_RECOVERY,
    // c'est que le lien est invalide ou expiré
