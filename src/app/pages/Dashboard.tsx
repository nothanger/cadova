...
function buildStats(userId: string): DashboardStats {
  ...
  // Profil completion — basé sur les actions réelles
  ...
  // Activité récente — merge toutes les actions et trie par date
  ...
  return (
    <AppLayout>
      <div className="max-w-6xl mx-auto" style={{ fontFamily: "DM Sans, system-ui, sans-serif" }}>
        ...
        {/* ══ SECTION 4 — Barres de progression réelles ══ */}
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
